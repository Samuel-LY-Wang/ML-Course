...
# test_solve_play()
# Tabular Q-learn
# test_learn_play(iters=2000000, tabular=True, batch=False)
# Tabular Batch Q-learn
# test_learn_play(iters=10000, tabular=True, batch=True) # Check: why do we want fewer iterations here?
# each iteration is essentially 1000 iterations of Q-learn
# NN Q-learn
